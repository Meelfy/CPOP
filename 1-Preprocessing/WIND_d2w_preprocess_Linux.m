function WIND_d2w_preprocess_Linux()
    clear all;
    clc;
    addpath(genpath(pwd));
    file_type = 'nc';
    file_path = '/data1/dataset-meijie/wind';
    
    % 得到所有的nc文件
    file_name = findFileAll_Linux(file_path, file_type);
    ...
    % ************读取所有OISST的week******************%
    file_path_OISST = '/data1/dataset-meijie/OISST/daily/GRIB/';
